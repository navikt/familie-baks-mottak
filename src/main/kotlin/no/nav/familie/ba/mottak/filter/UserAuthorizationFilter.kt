package no.nav.familie.ba.mottak.filter
...
@Component
class UserAuthorizationFilter(@Value("\${MOTTAK_ROLLE:group1}") val påkrevdRolle: String,
                              private val oidcUtil: OIDCUtil) : OncePerRequestFilter() {
    ...
    override fun shouldNotFilter(request: HttpServletRequest): Boolean {
        ...
        return path.startsWith("/api/soknadmedvedlegg") || path.startsWith("/internal/") || path.startsWith("/api/soknad") || path.startsWith("/api/hendelse")}
