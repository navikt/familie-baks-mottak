...
class GammelPdfService(
    ...
    override fun lagBarnetrygdPdf(
        ...
        return pdfClient.lagPdf(
            barnetrygdSøknadMapForSpråk + ekstraFelterMap,
            path,
        )
    }

    override fun lagKontantstøttePdf(
        ...
        return pdfClient.lagPdf(
            kontantstøtteSøknadMapForSpråk + ekstraFelterMap,
